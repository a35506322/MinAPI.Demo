namespace MinAPI.Demo.Infrastructures.NSwag;

public static class NSwagConfigure
{
    public static void NSwagSetting(this IServiceCollection services, IWebHostEnvironment env)
    {
